<template>
    ...
    <div class="side">
        <div class="user">
            <img :src=this.user_ong_photo alt="">
            <p class="us">{{ this.user_ong_api }}</p>
        </div>
        ...
        <div class="item">
            ...
            <div class="items">
                <i class='bx bx-user'><span class="usuario">Instituição</span></i>
        
                <i class="bx bx-chevron-down dropw" v-on:click="showMenu"></i>
        
                <div class="dropdown">
                    <div class="drop-info">
                        <RouterLink  to="/perfil-ong"> Perfil</RouterLink>
                        <RouterLink  to="/feed-ong"> Publicações</RouterLink>
                    </div>
                </div>
            </div>
            <RouterLink class="items" to="/carteira-vol">
                <i class="bx bx-wallet"><span>Carteira</span></i>
            </RouterLink>  
            <RouterLink class="items" to="/configuracao-vol">
                <i class="bx bx-cog"><span>Configuração</span></i>
            </RouterLink>
   ...
   <div class="botao">
    <Button id="bt" class='seta' @click="open"><i class="bx bx-menu"></i></Button>
   </div>
</template>
...
export default {
    ...
    mounted(){
        this.user_ong_api = getAuth().currentUser.displayName
        this.user_ong_photo = getAuth().currentUser.photoURL
    }
}
