<template>
    <div class="cadastro-vol">
        ...
        <label>Gênero</label>
        <select v-model="genero" placeholder="Informe seu gênero" required>
        ...
        <label>Idade</label>
        <input type="date" v-model="idade" placeholder="Idade" required>
        ...
        <div class="checkbox">   
            ...
            <button @click="cadastroVol">CADASTRAR</button>
        </div>
</template>
        ...
        cadastroVol: function(){
            ...
            if(termos === true){
                ...
                .then((userCredential) => {
                    ...
                    .then(() => {
                        this.$router.push({name: 'AtualizarPerfilVol'});
                    })
                    .catch((error) => {
